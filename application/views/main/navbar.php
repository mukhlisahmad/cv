...
<div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold">wellcome </span>
            </a>
        ...
        <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
						...
						<li class="menu-item">
                    <a href="" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons fa-solid fa-people-robbery"></i>

                        <div data-i18n="RMIB">RMIB</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="<?php echo base_url('C_admin/pertanyaan_rmib'); ?>" class="menu-link">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="<?php echo base_url('C_admin/saran_rmib'); ?>" class="menu-link">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="<?php echo base_url('/rmib/C_soalrmib/index') ?>" class="menu-link">
						...
						<li class="menu-item">
                    <a href="" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons fa-solid fa-person-rays"></i>

                        <div data-i18n="IST">IST</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="" class="menu-link">

                            <div data-i18n="Table data">Table data</div>
                            </a>
                        </li>
                    </ul>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            ...
                            <div data-i18n="Pernyataan">Pernyataan</div>
                            </a>
                        </li>
                    </ul>
                    <ul class="menu-sub">
